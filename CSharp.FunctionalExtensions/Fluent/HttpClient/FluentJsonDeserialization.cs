...
public static class FluentJsonDeserialization
{
    ...
    public static T? DeserializeJson<T>(
        ...
        value.DeserializeJson<T>(FluentHttpClientOptions.DefaultJsonSerializerOptions);
    ...
    /// <summary>
    /// Asynchronously reads the UTF-8 encoded text of <see cref="HttpResponseMessage.Content" />
    /// representing a single JSON value into an instance of a type specified by a generic type
    ...
    /// <returns>
    /// A T representation of the JSON value or the result of the default action if an exception is
    /// thrown during the deserialization process.
    /// </returns>
    /// <exception cref="ArgumentNullException" />
    public static async Task<T?> DeserializeJsonAsync<T>(
        this Task<HttpResponseMessage> responseMessageTask,
        Func<HttpResponseMessage,
        Exception,
        Task<T>> defaultAction
    )
    {
    ...
    public static async Task<T?> DeserializeJsonAsync<T>(
        this HttpResponseMessage responseMessage,
        Func<HttpResponseMessage, Exception, T> defaultAction
    )
    {
        return await responseMessage
            .DeserializeJsonAsync<T>(defaultAction, FluentHttpClientOptions.DefaultJsonSerializerOptions, CancellationToken.None)
    ...
    /// <summary>
    /// Asynchronously reads the UTF-8 encoded text representing a single JSON value into an
    /// instance of a type specified by a generic type parameter. The stream will be read to completion.
    /// </summary>
    /// <typeparam name="T"></typeparam>
    ...
    public static async Task<T?> DeserializeJsonAsync<T>(
        ...
        Func<Exception, Task<T>> defaultAction
    )
    {
    ...
    public static async Task<T?> DeserializeJsonAsync<T>(
        this Task<Stream> streamTask,
        Func<Exception, T> defaultAction
    )
    {
        return await streamTask
            .DeserializeJsonAsync<T>(defaultAction, FluentHttpClientOptions.DefaultJsonSerializerOptions, CancellationToken.None)
    ...
    /// <exception cref="ArgumentNullException" />
    public static async Task<T?> DeserializeJsonAsync<T>(
        this Stream stream, Func<Exception, Task<T>> defaultAction,
        JsonSerializerOptions options
    )
    {
        return await stream
