...
{
    /// <summary>
    /// Asynchronously creates a new XElement and initializes its underlying XML tree using the
    /// stream from the <see cref="HttpResponseMessage.Content" />.
    /// </summary>
    /// <param name="taskResponse"></param>
    /// <returns>
    /// A new XElement containing the contents of the <see cref="HttpResponseMessage.Content" /> stream.
    /// </returns>
    ...
    /// <summary>
    /// Asynchronously creates a new XElement and initializes its underlying XML tree using the
    /// stream from the <see cref="HttpResponseMessage.Content" />, optionally preserving white space.
    /// </summary>
    /// <param name="taskResponse"></param>
    ...
    /// <summary>
    /// Deserializes the XML document contained in <see cref="HttpResponseMessage.Content" /> to an
    /// instance of type T.
    /// </summary>
