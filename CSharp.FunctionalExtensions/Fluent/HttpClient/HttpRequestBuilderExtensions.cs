...
public static class HttpRequestBuilderExtensions
{
    ...
    /// <returns></returns>
    public static HttpRequestBuilder ConfigureOptions(
        this HttpRequestBuilder builder,
        Action<HttpRequestOptions> action
    )
    {
    ...
    /// <returns></returns>
    public static HttpRequestBuilder UsingVersion(
        this HttpRequestBuilder builder,
        string version
    )
    {
    ...
    /// <summary>
    /// Sets the HTTP message version and the policy that determines how <see cref="Version" /> is
    /// interpreted and how the final HTTP version is negotiated with the server.
    /// </summary>
    /// <param name="builder"></param>
    /// <param name="version"></param>
    ...
    /// <returns></returns>
    public static HttpRequestBuilder WithAuthentication(
        this HttpRequestBuilder builder,
        string scheme,
        string token
    )
    ...
    /// <param name="token"></param>
    /// <returns></returns>
    public static HttpRequestBuilder WithBasicAuthentication(
        this HttpRequestBuilder builder,
        string token
    )
    {
    ...
    /// <summary>
    /// Sets the value of the authentication header for the request to Basic using the Base64
    /// encoded username and password as the token.
    /// </summary>
    /// <param name="builder"></param>
    ...
    /// <returns></returns>
    public static HttpRequestBuilder WithHeader(
        this HttpRequestBuilder builder,
        string key,
        string value
    )
    ...
    /// <summary>
    /// Creates a new instance of the <see cref="JsonContent" /> that contains the specified content
    /// serialized to JSON using the default JsonSerializerOptions and assigns it to the Content
    ...
    public static HttpRequestBuilder WithJsonContent<T>(this HttpRequestBuilder builder, T content) =>
        builder.WithJsonContent<T>(content, FluentHttpClientOptions.DefaultJsonSerializerOptions);

    /// <summary>
    /// Creates a new instance of the <see cref="JsonContent" /> that contains the specified content
    /// serialized to JSON using the provided JsonSerializerOptions and assigns it to the Content
    /// property of the HttpRequestMessage.
    /// </summary>
    /// <param name="builder"></param>
    /// <param name="content"></param>
    ...
    public static HttpRequestBuilder WithOAuthBearerToken(this HttpRequestBuilder builder, string token) =>
        builder.WithAuthentication("Bearer", token);
    ...
    public static HttpRequestBuilder WithQueryParam(this HttpRequestBuilder builder, string key, object? value) =>
        builder.WithQueryParam(key, (value != null) ? value.ToString() : string.Empty);
    ...
    /// <summary>
    /// Adds the key value pairs from the <see cref="NameValueCollection" /> as query parameters to
    /// the request Url.
    /// </summary>
    /// <param name="builder"></param>
    /// <param name="values"></param>
    ...
    /// <summary>
    /// Creates a new instance of the <see cref="StringContent" /> that contains the specified
    /// content serialized to XML using the <see cref="FluentXmlSerializer.DefaultSettings" /> and
    /// assigns it to the Content property of the HttpRequestMessage.
    /// </summary>
    ...
    public static HttpRequestBuilder WithXmlContent<T>(this HttpRequestBuilder builder, T obj) =>
        builder.WithXmlContent(obj, FluentXmlSerializer.DefaultSettings.Encoding, FluentXmlSerializer.DefaultContentType);
    ...
    public static HttpRequestBuilder WithXmlContent<T>(this HttpRequestBuilder builder, T obj, Encoding encoding) =>
        builder.WithXmlContent(obj, encoding, FluentXmlSerializer.DefaultContentType);
    ...
    public static HttpRequestBuilder WithXmlContent<T>(this HttpRequestBuilder builder, T obj, string contentType) =>
        builder.WithXmlContent(obj, FluentXmlSerializer.DefaultSettings.Encoding, contentType);
    ...
    /// <summary>
    /// Creates a new instance of the <see cref="StringContent" /> that contains the specified
    /// content and assigns it to the Content property of the HttpRequestMessage.
    /// </summary>
    /// <param name="builder"></param>
    /// <param name="xml"></param>
    /// <returns></returns>
    public static HttpRequestBuilder WithXmlContent(this HttpRequestBuilder builder, string xml) =>
        builder.WithXmlContent(xml, FluentXmlSerializer.DefaultSettings.Encoding, FluentXmlSerializer.DefaultContentType);
    ...
    public static HttpRequestBuilder WithXmlContent(this HttpRequestBuilder builder, string xml, Encoding encoding) =>
        builder.WithXmlContent(xml, encoding, FluentXmlSerializer.DefaultContentType);
    ...
    public static HttpRequestBuilder WithXmlContent(this HttpRequestBuilder builder, string xml, string contentType) =>
        builder.WithXmlContent(xml, FluentXmlSerializer.DefaultSettings.Encoding, contentType);
    ...
    public static async Task<HttpResponseMessage> DeleteAsync(this HttpRequestBuilder builder) =>
        await builder.SendAsync(HttpMethod.Delete).ConfigureAwait(false);
    ...
    public static async Task<HttpResponseMessage> DeleteAsync(this HttpRequestBuilder builder, HttpCompletionOption completionOption) =>
        await builder.SendAsync(HttpMethod.Delete, completionOption).ConfigureAwait(false);
    ...
    public static async Task<HttpResponseMessage> DeleteAsync(this HttpRequestBuilder builder, CancellationToken token) =>
        await builder.SendAsync(HttpMethod.Delete, token).ConfigureAwait(false);
    ...
    public static async Task<HttpResponseMessage> DeleteAsync(this HttpRequestBuilder builder, HttpCompletionOption completionOption, CancellationToken token) =>
        await builder.SendAsync(HttpMethod.Delete, completionOption, token).ConfigureAwait(false);
    ...
    public static async Task<HttpResponseMessage> GetAsync(this HttpRequestBuilder builder) =>
        await builder.SendAsync(HttpMethod.Get).ConfigureAwait(false);
    ...
    public static async Task<HttpResponseMessage> GetAsync(this HttpRequestBuilder builder, HttpCompletionOption completionOption) =>
        await builder.SendAsync(HttpMethod.Get, completionOption).ConfigureAwait(false);
    ...
    public static async Task<HttpResponseMessage> GetAsync(this HttpRequestBuilder builder, CancellationToken token) =>
        await builder.SendAsync(HttpMethod.Get, token).ConfigureAwait(false);
    ...
    public static async Task<HttpResponseMessage> GetAsync(this HttpRequestBuilder builder, HttpCompletionOption completionOption, CancellationToken token) =>
        await builder.SendAsync(HttpMethod.Get, completionOption, token).ConfigureAwait(false);
    ...
    public static async Task<HttpResponseMessage> PostAsync(this HttpRequestBuilder builder) =>
        await builder.SendAsync(HttpMethod.Post).ConfigureAwait(false);
    ...
    public static async Task<HttpResponseMessage> PostAsync(this HttpRequestBuilder builder, HttpCompletionOption completionOption) =>
        await builder.SendAsync(HttpMethod.Post, completionOption).ConfigureAwait(false);
    ...
    => await builder.SendAsync(HttpMethod.Post, token).ConfigureAwait(false);
    ...
    => await builder.SendAsync(HttpMethod.Post, completionOption, token).ConfigureAwait(false);
    ...
    => await builder.SendAsync(HttpMethod.Put).ConfigureAwait(false);
    ...
    => await builder.SendAsync(HttpMethod.Put, completionOption).ConfigureAwait(false);
    ...
    => await builder.SendAsync(HttpMethod.Put, token).ConfigureAwait(false);
    ...
    => await builder.SendAsync(HttpMethod.Put, completionOption, token).ConfigureAwait(false);
}