using CSharp.FunctionalExtensions.Fluent.HttpClient;
...
/// </summary>
public class HttpRequestBuilder([NotNull] System.Net.Http.HttpClient client)
{
    ...
    /// <summary>
    /// Gets or sets a boolean value to indicate whether content should be buffered (serialized)
    /// prior to sending the request.
    /// </summary>
    /// <remarks>
    /// For use in rare edge cases; see
    /// <a href="https://github.com/dotnet/runtime/issues/30283">this issue</a>.
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// Trailing slashes on the route will be removed. If <see cref="HttpClient.BaseAddress" /> has
    /// a value, then this value will be appended to it.
    /// </remarks>
    ...
    /// <summary>
    /// Gets or sets the policy that determines how <see cref="Version" /> is interpreted and how
    /// the final HTTP version is negotiated with the server.
    /// </summary>
    ...
    public HttpRequestBuilder(System.Net.Http.HttpClient client, string route) : this(client)
    {
        Route = route;
    }
    ...
    public Task<HttpResponseMessage> SendAsync(HttpMethod method, CancellationToken token) =>
        SendAsync(method, HttpCompletionOption.ResponseContentRead, token);
