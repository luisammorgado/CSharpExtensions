...
/// <summary>
/// Extension methods for getting the content of an <see cref="HttpResponseMessage" /> and taking
/// default actions based on success or failure.
/// </summary>
public static class HttpResponseMessageExtensions
{
    ...
    public static async Task<string> GetResponseStringAsync(
    ...
    /// <summary>
    /// Assign an async delegate to execute if
    ...
    public static async Task<HttpResponseMessage> OnFailureAsync(this Task<HttpResponseMessage> taskResponse, Func<HttpResponseMessage, Task> function)
    {
        ...
        if (!response.IsSuccessStatusCode)
            await function.Invoke(response).ConfigureAwait(false);
    ...
    /// <summary>
    /// Assign an async delegate to execute if
    /// <see cref="HttpResponseMessage.IsSuccessStatusCode" /> is true.
    /// </summary>
    /// <param name="taskResponse"></param>
    /// <param name="function"></param>
    /// <returns></returns>
