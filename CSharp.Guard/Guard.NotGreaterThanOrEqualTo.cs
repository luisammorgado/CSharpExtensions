...
public static partial class Guard
{
    ...
    /// <summary>
    /// Guards the specified <paramref name="param" /> from being greater than or equal to the
    /// specified <paramref name="threshold" /> by throwing an exception of type
    ...
    where TParam : IComparable<TParam> =>
        NotGreaterThanOrEqualTo(param, threshold, paramName, "");
