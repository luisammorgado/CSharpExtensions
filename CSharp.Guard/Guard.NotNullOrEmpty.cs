...
public static partial class Guard
{
    ...
    /// <summary>
    /// Guards the specified <paramref name="param" /> from being null or empty (white-space
    /// allowed) by throwing an exception of type <see cref="ArgumentException" /> when the
    ...
    public static void NotNullOrEmpty(string param, string paramName) =>
        NotNullOrEmpty(param, paramName, "");

    /// <summary>
    /// Guards the specified <paramref name="param" /> from being null or empty (white-space
    /// allowed) by throwing an exception of type <see cref="ArgumentException" /> with a specific
    ...
    /// <summary>
    /// Guards the specified <paramref name="param" /> from being null or empty (white-space
    /// allowed) by throwing an exception of type <typeparamref name="TException" /> when the
    /// precondition has not been met
    /// </summary>
    /// <param name="param">The param to be checked</param>
    ...
    /// <summary>
    /// Guards the specified <paramref name="param" /> from being null or empty (white-space
    /// allowed) by throwing an exception of type <typeparamref name="TException" /> with a specific
    ///          <paramref name="message" /> when the precondition has not been met
    /// </summary>
    /// <param name="param">The param to be checked</param>
    /// <param name="message">The message that will be included in the exception</param>
    ...
    /// <summary>
    /// Guards the specified <paramref name="param" /> from being null or empty (white-space
    /// allowed) by throwing an <paramref name="exception" /> of type
