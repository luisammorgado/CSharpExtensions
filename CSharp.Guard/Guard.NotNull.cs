...
public static partial class Guard
{
    ...
    /// <summary>
    /// Guards the specified <paramref name="param" /> from being null by throwing an exception of
    /// type <see cref="ArgumentNullException" /> when the precondition has not been met
    /// </summary>
    ...
    /// <summary>
    /// Guards the specified <paramref name="param" /> from being null by throwing an exception of
    /// type <see cref="ArgumentNullException" /> with a specific <paramref name="message" /> when
    ...
    where TParam : class
    {
        ...
        ArgumentNullException argumentNullException = new(paramName, message);
    ...
    /// <summary>
    /// Guards the specified <paramref name="param" /> from being null by throwing an exception of
    /// type <typeparamref name="TException" /> when the precondition has not been met
    /// </summary>
    /// <typeparam name="TParam">The param Type (any reference type)</typeparam>
    /// <typeparam name="TException">
    /// The exception Type (Exception) to be thrown if the precondition has not been met
    /// </typeparam>
    /// <param name="param">The param to be checked</param>
    ...
    /// <summary>
    /// Guards the specified <paramref name="param" /> from being null by throwing an exception of
    /// type <typeparamref name="TException" /> with a specific <paramref name="message" /> when the
    ...
    /// <summary>
    /// Guards the specified <paramref name="param" /> from being null by throwing an
