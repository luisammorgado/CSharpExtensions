...
public static partial class Guard
{
    ...
    /// throwing an exception of type <see cref="ArgumentException" /> when the precondition has not
    /// been met
    /// </summary>
    ...
    public static void NotNullOrWhitespace(string param, string paramName) =>
        NotNullOrWhitespace(param, paramName, "");

    /// <summary>
    /// Guards the specified <paramref name="param" /> from being null, empty or white-space by
    /// throwing an exception of type <see cref="ArgumentException" /> with a specific
    ...
    /// <summary>
    /// Guards the specified <paramref name="param" /> from being null, empty or white-space by
    /// throwing an exception of type <typeparamref name="TException" /> when the precondition has
    /// not been met
    /// </summary>
    /// <param name="param">The param to be checked</param>
    ...
    /// <summary>
    /// Guards the specified <paramref name="param" /> from being null, empty or white-space by
    /// throwing an exception of type <typeparamref name="TException" /> with a specific
    /// <paramref name="message" /> when the precondition has not been met
    /// </summary>
    /// <param name="param">The param to be checked</param>
    /// <param name="message">The message that will be included in the exception</param>
